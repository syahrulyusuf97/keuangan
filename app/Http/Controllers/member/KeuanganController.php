        ...
        return DataTables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                if ($this->agent->isMobile()) {
                    ...
                    return '<p class="text-center"><a href="#" data-turbolinks="false" onclick="return alertConfirm(\''. 'Konfirmasi'.'\', \''. 'Apakah anda yakin akan menghapus data ini?'.'\', \''.url('/kas/debet/hapus/'.Crypt::encrypt($data->c_id)).'\')" class="text-danger" style="padding: 4px; font-size: 14px;"><i class="fa fa-trash"></i> Hapus</a>&nbsp; || &nbsp;<a href="javascript:void(0)" data-turbolinks="false" onclick="edit(\''. Crypt::encrypt($data->c_id) . '\'  )" class="text-blue" style="padding: 4px; font-size: 14px;"><i class="fa fa-pencil"></i> Edit</a></p>';
                }
        ...
        return DataTables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                if ($this->agent->isMobile()) {
                    ...
                    return '<p class="text-center"><a href="#" data-turbolinks="false" onclick="return alertConfirm(\''. 'Konfirmasi'.'\', \''. 'Apakah anda yakin akan menghapus data ini?'.'\', \''.url('/kas/kredit/hapus/'.Crypt::encrypt($data->c_id)).'\')" class="text-danger" style="padding: 4px; font-size: 14px;"><i class="fa fa-trash"></i> Hapus</a>&nbsp; || &nbsp;<a href="javascript:void(0)" data-turbolinks="false" onclick="edit(\''. Crypt::encrypt($data->c_id) . '\'  )" class="text-blue" style="padding: 4px; font-size: 14px;"><i class="fa fa-pencil"></i> Edit</a></p>';
                }
        ...
        return DataTables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                if ($this->agent->isMobile()) {
                    ...
                    return '<p class="text-center"><a href="#" data-turbolinks="false" onclick="return alertConfirm(\''. 'Konfirmasi'.'\', \''. 'Apakah anda yakin akan menghapus data ini?'.'\', \''.url('/bank/debet/hapus/'.Crypt::encrypt($data->c_id)).'\')" class="text-danger" style="padding: 4px; font-size: 14px;"><i class="fa fa-trash"></i> Hapus</a>&nbsp; || &nbsp;<a href="javascript:void(0)" data-turbolinks="false" onclick="edit(\''. Crypt::encrypt($data->c_id) . '\'  )" class="text-blue" style="padding: 4px; font-size: 14px;"><i class="fa fa-pencil"></i> Edit</a></p>';
                }
        ...
        return DataTables::of($data)
            ...
            ->addColumn('aksi', function ($data) {
                ...
                if ($this->agent->isMobile()) {
                    ...
                    return '<p class="text-center"><a href="#" data-turbolinks="false" onclick="return alertConfirm(\''. 'Konfirmasi'.'\', \''. 'Apakah anda yakin akan menghapus data ini?'.'\', \''.url('/bank/kredit/hapus/'.Crypt::encrypt($data->c_id)).'\')" class="text-danger" style="padding: 4px; font-size: 14px;"><i class="fa fa-trash"></i> Hapus</a>&nbsp; || &nbsp;<a href="javascript:void(0)" data-turbolinks="false" onclick="edit(\''. Crypt::encrypt($data->c_id) . '\'  )" class="text-blue" style="padding: 4px; font-size: 14px;"><i class="fa fa-pencil"></i> Edit</a></p>';
                }
