		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box">
				<div class="box-header with-border">
					...
					@if($edit == "true")
					<a href="{{url('/admin/index/kebijakan')}}" class="btn btn-warning pull-right"><i class="fa fa-times"></i> Batal</a>
					@else
					<a href="{{url('/admin/index/kebijakan?edit=true')}}" class="btn btn-warning pull-right"><i class="fa fa-pencil"></i> Edit</a>
					@endif
				</div>
				<form class="form-horizontal" method="post" action="{{url('/admin/index/kebijakan')}}" id="form_submit" onsubmit="{$('#btn_submit').attr('disabled', true)}">{{ csrf_field() }}
