		...
		<div class="col-lg-3 col-xs-6">
			...
			<div class="small-box bg-yellow">
				<div class="inner">
					...
					<p>Total Kas Keluar Bulan Lalu</p>
				</div>
				<div class="icon">
          ...
          <!-- BAR CHART -->
	      	<div class="box box-success">
		        <div class="box-header with-border">
		          <h3 class="box-title analisa">Laporan Keuangan Tahun {{ date('Y', strtotime('-1 year')) }}</h3>
			...
			<div class="box box-solid bg-green-gradient">
				...
				<div class="box-footer text-black">
					<div class="row">
						<div class="col-sm-6">
							<!-- Progress bars -->
							<h4 class="text-center">Riwayat kas masuk hari ini</h4>
							<hr>
						...
						<!-- /.col -->
						<div class="col-sm-6">
							<h4 class="text-center">Riwayat kas keluar hari ini</h4>
							<hr>
							<div class="table-responsive">
