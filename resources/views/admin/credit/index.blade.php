						...
						<form class="form-horizontal" method="post" action="{{ url('/credit') }}">{{ csrf_field() }}
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah Credit...">
									</div>
								</div>
								<div class="form-group">
					...
					<fieldset>
						...
						<section>
							<div class="row">
								...
								<div class="col-sm-10">
									<label class="input col-sm-12">
										<input type="text" class="form-control jml" name="jumlah_edit" id="jumlah_edit" />
									</label>
								</div>
							</div>
						</section>
