            ...
            <div class="col-md-12 box box-primary">
                <div class="box-body">
                    ...
                    <div style="display: none" id="edit_nama">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/admin/profile/update-nama')}}">{{ csrf_field() }}
                                <div class="box-body">
                    ...
                    <div style="display: none"  id="edit_email">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/admin/profile/update-email')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none"  id="edit_username">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/admin/profile/update-username')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none" id="edit_password">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/admin/profile/update-password')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none" id="edit_ttl">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/admin/profile/update-ttl')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
                    ...
                    <div style="display: none"  id="edit_alamat">
                        <strong>
                            <form class="form-horizontal" method="post" action="{{url('/admin/profile/update-alamat')}}">{{ csrf_field() }}
                                <div class="box-body">
                                    <div class="form-group">
    ...
    <div class="modal modal-primary fade" id="foto-profil">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="{{url('/admin/profile/update-foto')}}" enctype="multipart/form-data">{{csrf_field()}}
