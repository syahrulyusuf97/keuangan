...
<section class="content">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box box-primary">
				<div class="col-md-6" style="margin-top: 30px;">
					<div class="box">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Form Tambah Bank Debet</h3>
						</div>
						<!-- /.box-header -->
						<!-- form start -->
						<!-- <form class="form-horizontal" method="post" action="{{ url('/bank/bank-masuk') }}" autocomplete="off" onsubmit="{$('#btn_submit').attr('disabled', true)}"> -->
						<form class="form-horizontal" id="form_bank_debet" autocomplete="off">
							{{ csrf_field() }}
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
										<!-- <input type="text" class="form-control" id="ket" name="ket" placeholder="Keterangan bank masuk..." required> -->
										<textarea class="form-control" id="ket" name="ket" placeholder="Keterangan bank debet..." required></textarea>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
										<input type="text" class="form-control" id="jumlah" name="jumlah" onkeypress="return isNumberKey(event)" placeholder="Jumlah debet" required>
									</div>
								</div>
								<div class="form-group">
				...
				<div class="col-md-6" style="margin-top: 30px;">
					<div class="box">
						<div class="box-header with-border">
							<h3 class="box-title">Akumulasi Total Bank Debet</h3>
						...
						<form class="form-horizontal">
							...
							<!-- /.box-body -->
							<div class="box-footer">
								<h3 class="pull-left">Total Bank Debet</h3>
						...
						{{-- <div class="box-footer">
							...
							<h3 class="pull-right sisa_saldo_bank" id="txt_saldo_bank">{{ Helper::displayRupiah($saldo_bank) }}</h3>
						</div> --}}
					</div> 
				</div>
			</div>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Daftar Bank Debet</h3>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Edit Bank Debet</h4>
			</div>
			<!-- <form class="form-horizontal" method="post" action="{{ url('/bank/masuk/edit') }}"> -->
			<form class="form-horizontal" id="form_bank_debet_edit" method="POST">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Rincian Bank Debet</h4>
      </div>
      <div class="modal-body">
