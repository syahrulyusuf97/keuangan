...
<section class="content">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box box-primary">
				<div class="col-md-6" style="margin-top: 30px;">
					<div class="box">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Form Tambah Bank Masuk</h3>
						</div>
						<!-- /.box-header -->
						<!-- form start -->
							...
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
										...
										<textarea class="form-control" id="ket" name="ket" placeholder="Keterangan bank masuk..." required></textarea>
									</div>
								</div>
								<div class="form-group">
				...
				<div class="col-md-6" style="margin-top: 30px;">
					<div class="box">
						<div class="box-header with-border">
							<h3 class="box-title">Akumulasi Total Bank Masuk</h3>
						...
						<form class="form-horizontal">
							...
							<!-- /.box-body -->
							<div class="box-footer">
								<h3 class="pull-left">Total Bank Masuk</h3>
								<h3 class="pull-right" id="txt_total_deposito"></h3>
							</div>
							<!-- /.box-footer -->
						</form>
						<div class="box-footer">
							<h3 class="pull-left">Saldo Bank</h3>
							<h3 class="pull-right" id="txt_saldo_bank">{{ Helper::displayRupiah($saldo_bank) }}</h3>
						</div>
					</div> 
				</div>
			</div>
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Daftar Bank Masuk</h3>
				</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Edit Bank Masuk</h4>
			</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Rincian Bank Masuk</h4>
      </div>
      <div class="modal-body">
