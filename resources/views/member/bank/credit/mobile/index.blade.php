                ...
                <div class="action-sheet-content">
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <textarea class="form-control form-control-lg" id="kep" name="kep" placeholder="Keperluan bank keluar..." required></textarea>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function add() {
        $('#id').val("");
        $("#form_data")[0].reset();
        $("#modal_form .modal-title").html('Tambah Bank Keluar');
        $("#modal_form").modal('show');
    }

    function edit(id) {
        $("#modal_form .modal-title").html('Edit Bank Keluar');
        $.getJSON(baseUrl+'/bank/keluar/detail/'+id, function(resp){
            $('#id').val(resp.id);
	...
	$(document).on('turbolinks:load', function(){
		table = $('#bank_credit_mobile').dataTable({
			"processing": true,
			"serverSide": true,
            "destroy": true,
    ...
    $("#form_data").submit(function(evt){
        evt.preventDefault();
        postData(baseUrl+"/mobile/bank/keluar/add", $("#form_data").serialize(), "#modal_form").done(function(response){
