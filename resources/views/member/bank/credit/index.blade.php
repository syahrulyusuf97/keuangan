			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box box-primary">
				<div class="col-md-6" style="margin-top: 30px;">
					<div class="box">
						...
						<!-- /.box-header -->
						<!-- form start -->
						<form class="form-horizontal" method="post" action="{{ url('/bank/bank-keluar') }}" onsubmit="{$('#btn_submit').attr('disabled', true)}">{{ csrf_field() }}
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
										<select class="form-control select2" name="dariakun" id="dariakun">
...
<script type="text/javascript">
	$(function() {
	    ...
	    function lastMonthYear() {
	    	...
	    	$.getJSON(baseUrl+'/bank/keluar/akumulasi/'+nilai+'_null', function(resp){
	    ...
	    function pertanggal() {
	    	...
	    	$.getJSON(baseUrl+'/bank/keluar/akumulasi/'+nilai+'_'+tgl, function(resp){
		        $('#txt_total_credit').html('Rp'+number_format(resp.total, '2', ',', '.'));
		        var array_data = [];
             	var temp_array = [];
             	if (resp.result != "") {
	    ...
	    function pertahun() {
	    	...
	    	$.getJSON(baseUrl+'/bank/keluar/akumulasi/'+nilai+'_'+tahun, function(resp){
