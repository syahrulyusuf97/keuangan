            ...
            if ($("#akun_bulan").val() == "Kas") {
                ...
                $.ajax({
                    ...
                    if (results.length == 0) {
                       ...
                       //  });
                        ...
                        $("#total_debit_bulan").text(new Intl.NumberFormat('de-DE').format(total_debit_bulan));
                    }
                })
                ...
                $.ajax({
                    ...
                    if (results.length == 0) {
                        ...
                        $("#total_credit_bulan").text(new Intl.NumberFormat('de-DE').format(total_credit_bulan));
                    }
                })
                ...
                $.ajax({
                    ...
                    if (results.length == 0) {
                        ...
                        $("#dnt-ch-k-none").attr("style", "display:block").html('<h1 class="text-center">Tidak ada transaksi</h1>');
                    } else {
            ...
            if ($("#akun_tahun").val() == "Kas") {
                $.ajax({
                    ...
                    if (results.length == 0) {
                        ...
                        $("#total_debit_tahun").text(new Intl.NumberFormat('de-DE').format(total_debit_tahun));
                        $("#total_credit_tahun").text(new Intl.NumberFormat('de-DE').format(total_credit_tahun));
                    }
                })
                ...
                $.ajax({
                    ...
                    if (results.length == 0) {
                        ...
                        $("#dnt-ch-m-t-none").attr("style", "display:block").html('<h1 class="text-center">Tidak ada transaksi</h1>');
                    } else {
                ...
                $.ajax({
                    ...
                    if (results.length == 0) {
                        ...
                        $("#dnt-ch-k-t-none").attr("style", "display:block").html('<h1 class="text-center">Tidak ada transaksi</h1>');
                    } else {
