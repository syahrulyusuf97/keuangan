...
<script type="text/javascript">
    $(function () {
        ...
        function getRiwayat(tanggal)
        {
            ...
            $.getJSON(baseUrl+'/riwayat/get-kas/'+tanggal, function(resp){
                // console.log(resp);
                ...
                $('#ttl_rkm').text("Riwayat kas masuk tanggal "+dateFormat(tanggal, "d-m-Y"));
                $('#ttl_rkk').text("Riwayat kas keluar tanggal "+dateFormat(tanggal, "d-m-Y"));
            });
        }
    })
</script>
